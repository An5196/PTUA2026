...
#### Repositories and setting up
 ...
 2. Get your [ssh keys][ssh] setup on your individual GitHub repository. The main steps you need to do to setup the ssh keys including [Checking for existing SSH keys][checkkey], [Generating a new SSH key][generatekey], [Adding a new SSH key to your GitHub account][addkey], and [Adding a new SSH key to your GitHub account][addgithub]. You do not need to do the set up for the ssh-agent.
...
[addgithub]: https://docs.github.com/en/authentication/connecting-to-github-with-ssh/adding-a-new-ssh-key-to-your-github-account
